...
useEffect(()=>{
    ...
    return ( 
        <div className="bg-[#eee]  w-full flex justify-center items-center relative">
            ...
            <div className=" w-[700px] bg-white p-5 md:my-20 rounded-md shadow shadow-lg shadow-slate-300">
